...
const Header = () => {
  return (
    <div className="max-w-[900px] max-md:max-w-xs mx-auto flex flex-col justify-center flex-grow items-center relative gap-8 max-md:gap-5 z-3">
      <h1 className="text-white text-8xl max-md:text-5xl font-heading text-center">
        Exquisite Boutique Resort Living
      </h1>
      <p className="text-white text-lg max-md:text-center max-md:text-base max-md:max-w-[250px]">
